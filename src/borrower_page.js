        ...
        <div className="container" style={{ "z-index": "9" }}>
          <div className="row activation_cube" style={{ position: "relative" }}>
            <div className="col-lg-6 d-flex flex-column justify-content-center">
              ...
              <h2 style={{ width: "80%" }}>
                Финансирование от частных инвесторов на ваших условиях. Создайте
                предложение <b>уже сегодня</b>!
              </h2>
              <div data-aos-delay="50">
                <div className="text-center text-lg-start">
                  <Link
                    to="https://personal.qliqinvest.ru"
                    className="btn-get-started founder scrollto d-inline-flex align-items-center justify-content-center align-self-center"
                  >
      ...
      <section id="team" className="team">
        <div className="container">
          <header className="section-header">
            ...
            <br />
            <h5 className="prem">
              Работающий бизнес, порядок с финансовыми документами и четкий план
              развития бизнеса позволят вам привлечь финансирование от частных
              инвесторов!
            </h5>
          </header>
          ...
          <div className="row gy-4 multiple_arrow">
            <div
              className="qliq-stage invest_req col d-flex align-items-stretch"
              data-stage="01"
              data-aos-delay="0"
            >
              <div className="member">
                <div className="stage">
                  <i aria-hidden="true" className="fas fa-user-check"></i>
                </div>
                ...
                <div className="member-info">
                  ...
                  <div className="req">
                    ...
                    <ul>
                      <li>Паспорт РФ (разворот с фото и прописка)</li>
                      <li>ИНН</li>
                      <li>Реквизиты для перечисления денежных средств</li>
                      <li>
                        Финансовая (бухгалтерская) отчетность, налоговые
                        декларации
                      </li>
                    </ul>
                  </div>{" "}
              ...
              <div className="member">
                ...
                <div className="member-info">
                  ...
                  <div className="req">
                    ...
                    <ul>
                      <li>Карточка предприятия (ИНН, банковские реквизиты)</li>
                      <li>Паспорта РФ директора и участников</li>
                      <li>Реквизиты для перечисления денежных средств</li>
                      <li>
                        Финансовая (бухгалтерская) отчетность, налоговые
                        декларации
      ...
      <section id="contact" className="contact qliq_preim features">
        <div className="container aos-init aos-animate" data-aos="fade-up">
          <header className="section-header">
            ...
            <br />
            <h5 className="prem">
              Каждая компания проходит несколько этапов тщательной проверки в
              процессе регистрации и подготовки инвестпредложения для публикации
              на платформе
            </h5>
          </header>
              ...
              <div className="outer">
                <div className="time_card">
                  <div className="info">
                    ...
                    <p>
                      <p>
                        Создайте аккаунт на платформе qliq для себя и своей
                        компании.
                      </p>
                    </p>
                  </div>
                ...
                <div className="time_card">
                  <div className="info">
                    ...
                    <p>
                      <p>Ответьте на вопросы анкеты и загрузите документы.</p>
                    </p>
                  </div>
                </div>
                <div className="time_card">
                  <div className="info">
                    ...
                    <p>
                      <p>Пройдите проверку документов</p>
                    </p>
                  </div>
                </div>
                <div className="time_card">
                  <div className="info">
                    ...
                    <h3 className="pre_title">
                      Оформление инвестиционного предложения
                    </h3>
                    <p>
                      <p>
                        Создайте инвестиционное предложение, расскажите о своей
                        компании и целях привлечения инвестиций.
                      </p>
                    </p>
                  </div>
                </div>
                <div className="time_card">
                  <div className="info">
                    ...
                    <p>
                      <p>
                        После проверки на соответствие требованиям ваше
                        инвестиционное предложение будет опубликовано.
                      </p>
                    </p>
                  </div>
                </div>
                <div className="time_card">
                  <div className="info">
                    ...
                    <p>
                      <p>
                        Платформа предложит ваше предложение частным инвесторам
                        и компаниям, зарегистрированным на платформе.
                      </p>
                    </p>
                  </div>
                </div>
